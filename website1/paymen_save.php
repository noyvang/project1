...
$insert=mysqli_query($conn,"insert into payment(fname,lname,gender,dob,village,district,province,tel,eid,amount,date,userid,remark)values('$fname','$lname','$gender','$dob','$village','$district','$province','$tel','$eid','$amount','$date','$userid','')");
