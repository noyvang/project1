...
<form class="form-horizontal" role="form">
	<div class="container">
		...
		<div class="form-group">
					...
					<div class="col-sm-3">
					<a href="payment_table.php">	<button type="button" class="btn btn-primary btn-block">ກວດສອບ</button></a>
					</div>
				</div>
	</div>
	<div class="col-sm-6">
	<iframe name="myframe" src="bill.php" width="100%" height="500"></iframe>
	</div>
	</div>
<form><?php
}
